...
function StatusRow({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: "#999", fontSize: 13 }, children: label }),
...
function formatAgo(iso) {
  const delta = Math.floor((Date.now() - new Date(iso).getTime()) / 1e3);
...
function Dashboard({ onOpenSettings }) {
  ...
  const lastUploadLabel = status.lastUpload ? `${status.lastUpload.track} — ${status.lastUpload.lapTime} (${formatAgo(status.lastUpload.at)})` : "—";
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      style: {
      ...
      children: [
          ...
          "div",
          {
            ...
            children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "flex", alignItems: "center", gap: 10 }, children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { fontWeight: 600, fontSize: 15, color: "#fff", letterSpacing: -0.3 }, children: "F1SimHub Companion" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { fontSize: 11, color: "#555", marginTop: 1 }, children: status.currentSession ? `Session active — ${status.currentSession.lapCount} lap${status.currentSession.lapCount !== 1 ? "s" : ""} on ${status.currentSession.track}` : "Waiting for session…" })
              ] })
            ] })
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { flex: 1 }, children: [
          ...
          status.pendingUploads > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              style: {
                margin: "0 20px",
...
function StepIndicator({ current, total }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { display: "flex", gap: 6, justifyContent: "center", marginBottom: 28 }, children: Array.from({ length: total }, (_, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
    "div",
    {
      style: {
...
function Wizard({ onComplete }) {
  ...
  const [localIPs, setLocalIPs] = reactExports.useState([]);
  const [waitingForPacket, setWaitingForPacket] = reactExports.useState(false);
  reactExports.useEffect(() => {
    if (step === 2) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "flex", alignItems: "center", gap: 10, marginBottom: 32 }, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              style: {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { fontWeight: 600, fontSize: 16, color: "#fff" }, children: "F1SimHub Companion" })
        ] }),
        ...
        step === 1 && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { style: { fontSize: 20, fontWeight: 700, color: "#fff", marginBottom: 8 }, children: "Paste your API Key" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { style: { color: "#666", fontSize: 13, marginBottom: 24, lineHeight: 1.6 }, children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "span",
              {
                ...
                onClick: () => window.companion.openF1SimHub(),
                children: "f1simhub.com/companion"
              }
            ),
            " ",
          ...
          verifyError && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { style: { color: "#f87171", fontSize: 12, marginBottom: 12 }, children: verifyError }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              ...
              children: verifying ? "Verifying…" : "Verify & Continue →"
            }
          )
        ] }),
        step === 2 && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { style: { fontSize: 20, fontWeight: 700, color: "#fff", marginBottom: 8 }, children: "Configure F1 25" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { style: { color: "#666", fontSize: 13, marginBottom: 20, lineHeight: 1.6 }, children: [
            "In F1 25, go to ",
            /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { style: { color: "#ccc" }, children: "Settings → Telemetry Settings" }),
            " and set:"
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              ...
              children: [
                ...
                "div",
                {
                  ...
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: "#888", fontSize: 12 }, children: label }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "span",
                      {
                        style: {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              ...
              children: [
                "💡 To find your IP: open Command Prompt and type ",
                /* @__PURE__ */ jsxRuntimeExports.jsx("code", { children: "ipconfig" }),
                " (Windows) or Terminal → ",
                /* @__PURE__ */ jsxRuntimeExports.jsx("code", { children: "ifconfig" }),
                " (macOS). Look for IPv4 / inet."
              ]
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              ...
              children: "Done — Continue →"
            }
          )
        ] }),
        step === 3 && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { style: { fontSize: 20, fontWeight: 700, color: "#fff", marginBottom: 8 }, children: "Waiting for first packet" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { style: { color: "#666", fontSize: 13, marginBottom: 28, lineHeight: 1.6 }, children: "Start F1 25 and load into a session. The companion will detect the connection automatically." }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              style: {
              ...
              children: waitingForPacket ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "div",
                  {
                    style: {
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { style: { color: "#555", fontSize: 13 }, children: "Listening on port 20777…" })
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { style: { color: "#00d4b1", fontSize: 14, fontWeight: 600 }, children: "Connected — Setup complete!" })
              ] })
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
...
function Toggle({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { fontSize: 13, color: "#e5e5e5" }, children: label }),
          description && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { fontSize: 11, color: "#555", marginTop: 2 }, children: description })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
...
function Settings({ onBack }) {
  ...
  const [portInput, setPortInput] = reactExports.useState("");
  ...
  if (!settings) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { display: "flex", alignItems: "center", justifyContent: "center", height: "100vh" }, children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { color: "#555" }, children: "Loading…" }) });
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "flex", flexDirection: "column", height: "100vh", background: "#0f0f0f" }, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        style: {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { fontWeight: 600, fontSize: 15, color: "#fff" }, children: "Settings" }),
          saved && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { marginLeft: "auto", fontSize: 12, color: "#00d4b1" }, children: "Saved ✓" })
        ]
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { flex: 1, overflowY: "auto" }, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { padding: "14px 20px 8px", fontSize: 11, color: "#555", textTransform: "uppercase", letterSpacing: 1 }, children: "API Key" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { padding: "0 20px 14px", borderBottom: "1px solid #1e1e1e" }, children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { style: { fontSize: 11, color: "#444", marginTop: 8 }, children: [
          "Get your key at",
          " ",
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "span",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { padding: "14px 20px 8px", fontSize: 11, color: "#555", textTransform: "uppercase", letterSpacing: 1 }, children: "Connection" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { padding: "0 20px 14px", borderBottom: "1px solid #1e1e1e" }, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { fontSize: 13, color: "#999", marginBottom: 8 }, children: "UDP Port" }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { style: { fontSize: 11, color: "#444", marginTop: 6 }, children: "Default: 20777. Must match F1 25 settings." })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { padding: "14px 20px 8px", fontSize: 11, color: "#555", textTransform: "uppercase", letterSpacing: 1 }, children: "Behaviour" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        Toggle,
        {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { padding: "14px 20px", borderTop: "1px solid #1e1e1e", marginTop: 4, display: "flex", flexDirection: "column", gap: 8 }, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
      ...
      version && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { padding: "8px 20px 16px", textAlign: "center" }, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { style: { fontSize: 10, color: "#333", fontFamily: "monospace" }, children: [
        "v",
        version
      ] }) })
    ] })
...
function App() {
  ...
  const [wizardDone, setWizardDone] = reactExports.useState(null);
  reactExports.useEffect(() => {
    window.companion.getSettings().then((s) => {
  ...
  if (page === "settings") {
    return /* @__PURE__ */ jsxRuntimeExports.jsx(Settings, { onBack: () => setPage("dashboard") });
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Dashboard, { onOpenSettings: () => setPage("settings") });
}
